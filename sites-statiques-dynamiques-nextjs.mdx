...
Pour bien comprendre ce mécanisme et ses subtilités, il faut revenir au fondamentaux. A commencer par bien comprendre la différence entre une page web statique et dynamique (oui, les fondamentaux on a dit ! 😅)
